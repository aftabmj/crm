...
/*    login(type) {
    ...
    configureRouter(config: RouterConfiguration, router: Router): void {
        ...
        config.map([
          ...
          { route:'defendant-non-individual', name:'defendant-non-individual', title:'defendant Non-individual details', moduleId:'defendant-non-individual-details', nav:true},
          { route:'review-matter-create', name:'review-matter-create', title:'Review Matter Details', moduleId:'review-matter-create', nav:true },
          { route:'m/:id', name:'matter-details', title:'Matter details', moduleId:'m/matter-details', nav:false},
          { route:'m/:id/facilities', name:'facilities', title:'facility details', moduleId:'m/facility-details', nav:false},
          { route:'special-data-table', name:'special-data-table', title:'data tale', moduleId:'special-data-table', nav:true},
